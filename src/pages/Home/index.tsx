    ...
    <Flex vertical>
      <Row gutter={18}>
        <Col span={6}>
          ...
          >
            <h3 className='w-4/5 text-h3 text-white font-bold'>
          ...
          <Flex gap={18} vertical>
            <Card
              title={
                <CardHeader
                  title={
                    <span className='text-sm text-textPrimary'>Read more</span>
                  }
                  icon={
                    <RiShareForwardLine
                      className='bg-white rounded-full p-1'
            ...
            >
              <Flex justify='space-between' align='flex-end'>
                <h2 className='w-3/5 text-h2 text-textPrimary font-bold'>
                  32h
                </h2>
            ...
            <Row gutter={18}>
              <Col span={18}>
                ...
                >
                  <h2 className='w-3/5 text-h2 text-white font-bold'>+80%</h2>
                </Card>
              </Col>
              <Col span={6}>
        ...
        <Col span={5}>
          <Flex
            ...
            className='bg-tertiaryBackground rounded-2xl h-full px-6 py-5'
          >
            <Flex vertical gap={30}>
              <h5 className='text-white text-h5 font-semibold felx-1'>
                Until August choose a discount product. The best discount will
                always help you.
              </h5>
              <Avatar.Group>
        ...
        <Col span={7}>
          <Flex
            vertical
            justify='space-between'
            className='bg-info rounded-2xl h-full px-6 py-5'
          >
            <Flex vertical gap={20}>
              ...
              <Card title='Active Products' className='bg-warn rounded-2xl'>
                <h4 className='text-h4 text-textPrimary font-bold'>
                  120 Products
                </h4>
